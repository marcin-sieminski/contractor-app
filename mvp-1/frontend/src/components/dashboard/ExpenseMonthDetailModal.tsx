      ...
      >
        ...
        <div className="overflow-y-auto flex-1 px-5 py-3">
          {monthExpenses.length === 0 ? (
            <div className="text-gray-400 text-sm text-center py-10">Brak wydatków w tym miesiącu.</div>
          ) : (
    ...
    <div className="flex items-center gap-3 px-3 py-2.5 bg-white hover:bg-gray-50">
      ...
      <span className="flex-1 text-sm text-gray-700 truncate">
        ...
        {expense.receiptNumber && (
          <span className="ml-1.5 text-xs text-gray-400">#{expense.receiptNumber}</span>
        )}
      </span>
