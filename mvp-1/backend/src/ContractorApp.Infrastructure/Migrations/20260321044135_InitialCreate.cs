        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: false, defaultValue: "PL"),
                    IsVerified = table.Column<bool>(type: "boolean", nullable: false),
                    IsEuVatPayer = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExchangeRateTableNumber = table.Column<string>(type: "text", nullable: true),
                    ...
                    KsefSubmittedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    KsefError = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_IsInvoiced",
                table: "TimeEntries",
                column: "IsInvoiced");
